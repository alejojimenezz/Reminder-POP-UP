...
function activate(context) {
	...
	const disposable = vscode.commands.registerCommand('reminder-pop-up.helloWorld', function () {
		// The code you place here will be executed every time your command is executed

		// Display a message box to the user
		vscode.window.showInformationMessage('Hello World from Reminder POP-UP!');
	});
